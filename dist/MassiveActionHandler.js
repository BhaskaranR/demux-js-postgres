...
class MassiveActionHandler extends demux_1.AbstractActionHandler {
    ...
    updateIndexState(state, nextBlock, isReplay, handlerVersionName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const toSave = Object.assign({}, fromDb, { block_number: blockInfo.blockNumber, block_hash: blockInfo.blockHash, last_irreversible_block_number: nextBlock.lastIrreversibleBlockNumber, is_replay: isReplay, handler_version_name: handlerVersionName });
